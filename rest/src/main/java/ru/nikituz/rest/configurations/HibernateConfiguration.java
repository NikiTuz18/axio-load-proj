...
import ru.nikituz.rest.configurations.properties.DataSourceProperties;
...
@ComponentScan(basePackages = "ru.nikituz.rest")
...
public class HibernateConfiguration {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        factory.setPackagesToScan("ru.nikituz.rest");
